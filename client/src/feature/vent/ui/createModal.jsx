...
import { createSingleVent } from "../ventSlice";
import { openMoodModal, closeMoodModal } from "../../modalSlice";
        ...
        {!ismoodSelecting ? (
          <Box position={"relative"} p={4}>
            ...
            <CustomBox sx={{ mt: 2, justifyContent: "space-between" }}>
              ...
              <Button
                onClick={() => dispatch(openMoodModal())}
                variant="contained"
                sx={{ bgcolor: "#da254b", "&:hover": { bgcolor: "#e35b77" } }}
                disableElevation
              >
            ...
            >
              ...
              <Button
                ...
                sx={{
                  mt: 2,
                  bgcolor: "#da254b",
                  "&:hover": { bgcolor: "#e35b77" },
                }}
                disabled={error.errState && error.errType === "loading"}
                onClick={handlePost}
              >
                {error.errState && error.errType === "loading" ? (
                  <CircularProgress />
                ) : (
                  " send post"
                )}
              ...
              {error.errState && error.errType === "success" && (
                <Alert severity={error.errType} sx={{ mt: 2, width: "100%" }}>
              ...
              {emotions.map((emotion) => {
                return (
                  <Grid item lg={6}>
                    ...
                    >
                      <Avatar>{emotion.emoji}</Avatar>
                      <Typography mx={2} variant="v5" color="initial">
                        {emotion.text}
                      </Typography>
                    </Button>
                  </Grid>
